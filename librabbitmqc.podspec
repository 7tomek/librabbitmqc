Pod::Spec.new do |s|
  ...
  'rabbitmq-c/librabbitmq/unix/threads.h', 'rabbitmq-c/librabbitmq/amqp_api.c',
  'rabbitmq-c/librabbitmq/amqp_connection.c', 'rabbitmq-c/librabbitmq/amqp_consumer.c',
  ...
  s.ios.dependency 'OpenSSL-Universal', '1.0.1.l'
